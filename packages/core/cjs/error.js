...
exports.CustomError = ts_custom_error_1.CustomError;
class OneChainError extends ts_custom_error_1.CustomError {
...
exports.OneChainError = OneChainError;
...
class ParamError extends ts_custom_error_1.CustomError {
    constructor(code, message) {
        super(message);
...
class NetworkError extends ts_custom_error_1.CustomError {
    constructor(code, message, data = null) {
        super(message);
