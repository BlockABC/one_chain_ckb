...
export declare type bigNumber = string | number;
export declare type binStr = string | Buffer;
...
export interface IUTXOProvider {
     ...
     * @param logger
     */
    init({ name, rpcnode, keypairs, logger }: {
        name: string;
        rpcnode: RPCNode;
        keypairs: IKeypair[];
        logger?: ILogger;
...
export declare type IUTXOInput = IUTXOUnspent;
